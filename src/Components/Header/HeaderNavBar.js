...
export default function HeaderNavBar() {
    ...
    const catagoryLinks = [
        {
            title: "Одежда",
            links: [
                { title: "Все категории", url: "/shop-grid-left-sidebar" },
                { title: "Худи", url: "/shop-grid-left-sidebar" },
                { title: "Рубашки-поло", url: "/shop-grid-left-sidebar" },
                { title: "Кепки и панамы", url: "/shop-grid-left-sidebar" },
                { title: "Жилеты", url: "/shop-grid-left-sidebar" },
                { title: "Куртки", url: "/shop-grid-left-sidebar" },
                { title: "Свитшоты", url: "/shop-grid-left-sidebar" },
                { title: "Футболки", url: "/shop-grid-left-sidebar" },
                { title: "Пледы", url: "/shop-grid-left-sidebar" },
            ],
        },
        {
        ...
        },
        {
            ...
            links: [
                ...
                {
                    title: "Ложемент для коробки",
                    url: "/shop-grid-left-sidebar",
                },
                {
                    title: "Магнитные кейсы",
                    url: "/shop-grid-left-sidebar",
                },
            ],
        },
    ...
    //                 url: "/shop-grid-fullwidth",
    //             },
    //             {
    //                 title: "Shop List - Left Sidebar",
    //                 url: "/shop-list-left-sidebar",
    //             },
    //             {
    //                 title: "Shop List - Right Sidebar",
    //                 url: "/shop-list-right-sidebar",
    //             },
    //             {
            ...
            <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <nav className="navbar navbar-expand-lg navbar-light position-static">
                                        <Link
                                            className="navbar-brand logo d-lg-none"
                                            to="/"
                                        >
                                            <img
                                                className="img-fluid"
                                        ...
                                        <div className="right-nav align-items-center d-flex justify-content-end">
                                            ...
                                            >
                                                <span
                                                    className="bg-white px-2 py-1 shadow-sm rounded"
                                                    data-cart-items={
                                                        cartItems1.length
                                                    }
                                                >
                ...
                >
                    ...
                    <ModalBody>
                        ...
                        >
                            <i className="las la-shopping-cart mr-1"></i>View
                            Cart
                        </Link>
                        <Link to="/product-checkout" className="btn btn-dark">
                            <i className="las la-money-check mr-1"></i>Continue
                            To Checkout
                        </Link>
                    </ModalBody>
                </Modal>
